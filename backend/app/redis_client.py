...
class RedisStateStore:
    ...
    def update_analysis_status(self, analysis_id: str, status: str, result: dict[str, Any] | None = None) -> bool:
    ...
    def set_cache(self, key: str, value: Any, ttl: int | None = 86400) -> bool:
